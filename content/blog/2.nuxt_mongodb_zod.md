...
L'avantage de cette architecture est qu'elle permet de facilement encapsuler notre logique métier dans des "repositories" et avoir ainsi un code très expressif. Nous avons également une grande maitrise nos interractions avec la base de données sans la lourdeur et la complexité que peuvent apporter certains ORM. Aussi, nous avons à notre disposition des schémas de données que nous utilisons pour valider et typer nos données sans génération de code.
